...
.cloud-right {
    ...
    animation: move-cloud-left 35s linear infinite; /* Durasi 25 detik, berulang */
        ...
        .register-box {
            background-color: rgba(243, 233, 230, 0.63);
            padding: 30px;
            border-radius: 10px;
        ...
        button.btn-primary {
        background-color:rgba(242, 208, 127, 0.9);
...
<body>
    <!-- Gambar Awan -->
    <img src="../assets/img/kupu.png" alt="Cloud Left" class="cloud-left">
    <img src="../assets/img/nnn.png" alt="Cloud Right" class="cloud-right">
